							...
							<tbody>
								...
								*/?> 
								...
								<form role="form" method="post" name="f1">
									...
									<div class="form-group">
                                        <label><font color="red">&lowast;</font>Telephone No</label>
                                      <input type="text" class="form-control input-sm" name="txt_tpNo" placeholder="Please Enter Address" required value="<?php  if(isset($_POST['btn_add'])){echo $_POST['txt_tpNo'];}?>">
									</div>
									<div class="form-group">
