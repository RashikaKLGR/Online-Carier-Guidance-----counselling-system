...
<html  class="bootstrap-admin-vertical-centered">
    <head>
         <title>Shedule Business Loan Details</title>
			...
			<div class="col-lg-10">
				<section class="panel panel-transparent">
					<div class="panel-body panel-transparent">
						<h1> Shedule Business Loan Details </h1>
						<table class="table table-striped table-bordered display" id="example" width="100%">
							<thead>
								<tr>
									<th width="15%">Request Date</th>
									<th width="25%">Student</th>
									<th width="15%">Programme Date</th>
									<th width="30%">Message</th>
									<th width="15%">Approve Date</th>
							...
							<tbody>
								...
								<?php
									$sql4="SELECT *,student_businessloan_details.sys_enterdte AS regdate FROM  student_businessloan_details INNER JOIN student_master ON student_businessloan_details.student_key=student_master.studentmas_key
																					  WHERE student_businessloan_details.inform_status=1
									...
									while($row4=mysqli_fetch_array($result4)){
										...
										echo "<tr>
													...
													<td width='15%'>".$row4['programme_dte']."</td>
													<td width='30%'>".$row4['inform_message']."</td>
													<td width='15%'>".$row4['inform_datetime']."</td>
