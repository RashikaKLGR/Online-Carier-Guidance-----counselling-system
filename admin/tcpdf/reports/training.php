...
$curdte=date("Y-m-d");
	...
	class MYPDF extends TCPDF {
		...
		public function Header() {
			...
			$html ='<table border="0">
							...
							$html.= '<tr>
										<td width="100%" style="color:#001f4d;font-size:15px"><h5 align="center"> Request Training Report </h5> </td>
									</tr>';
	...
	$pdf->SetTitle('Request Training Report');
	...
	$html.='<tbody>';
			...
			$n=0;
            $sql3="SELECT *,student_trainingpoint_master.sys_enterdte AS regdate FROM student_trainingpoint_master INNER JOIN course_master ON student_trainingpoint_master.course_key=course_master.coursemas_key 
            ...
            while($row3=mysqli_fetch_array($result3)){
                ...
                $html.='<tr style="font-size:12px">';
					$html.='<td width="15%"> '.$row3['regdate'].'</td>';
					$html.='<td width="30%"> '.$row3['student_nme'].'</td>';
					$html.='<td width="30%"> '.$row3['course_nme'].'</td>';
					$html.='<td width="20%"> '.$row3['batch_nme'].'</td>';
...
$pdf->Output('Requesttraing.pdf', 'I');
