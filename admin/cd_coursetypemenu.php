					...
					<div class="panel-body panel-transparent">
						...
						<table class="table table-striped table-bordered display" id="example" width="100%">
							...
							<tbody>
								...
								<?php
									$sql4="SELECT * FROM coursetype_master WHERE finact=0 
																	   ORDER BY coursetype_mas_key DESC";
									$result4 = mysqli_query($link,$sql4);
									while($row4=mysqli_fetch_array($result4)){
										
										echo "<tr>
												<td width='40%'>".$row4['coursetype_nme']."</td>
												<td width='20%'>
													<a href='cd_coursetype.php?ct=".$row4['coursetype_mas_key']."'><button type='button' class='btn btn-sm btn-danger btn-block'>Delete</button></a>
												</td>
											</tr>";
									}
								?>
