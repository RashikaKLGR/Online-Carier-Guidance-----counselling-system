					...
					<div class="panel-body panel-transparent">
						...
						<table class="table table-striped table-bordered display" id="example" width="100%">
							...
							<tbody>
								...
								<?php
									$sql4="SELECT * FROM exam_master WHERE finact=0 
																	   ORDER BY exammas_key ASC";
									$result4 = mysqli_query($link,$sql4);
									while($row4=mysqli_fetch_array($result4)){
										
										echo "<tr>
												<td width='40%'>".$row4['exam_name']."</td>
												<td width='40%'>".$row4['stream']."</td>
												<td width='20%'>
													<a href='cd_exam.php?ex=".$row4['exammas_key']."'><button type='button' class='btn btn-sm btn-success btn-block'>Change</button></a>
												</td>
											</tr>";
									}
								?>
