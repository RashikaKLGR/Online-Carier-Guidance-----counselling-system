					...
					<div class="panel-body panel-transparent">
						...
						<table class="table table-striped table-bordered display" id="example" width="100%">
							...
							<tbody>
								...
								<?php
									$sql4="SELECT * FROM  course_level_master WHERE finact=0 
																	   ORDER BY courselevelmas_key DESC";
									$result4 = mysqli_query($link,$sql4);
									while($row4=mysqli_fetch_array($result4)){
										
										echo "<tr>
												<td width='40%'>".$row4['course_level']."</td>
												<td width='20%'>
													<a href='cd_courselevel.php?cl=".$row4['courselevelmas_key']."'><button type='button' class='btn btn-sm btn-danger btn-block'>Delete</button></a>
												</td>
											</tr>";
									}
								?>
