...
<?php
	$sql1="SELECT * FROM user_master WHERE NOT usermaster_key='$ses_ukey'";
	...
	if(isset($_POST['btn_resetpw'])){
		...
		while($row2=mysqli_fetch_array($result2)){
			 	$ukeyo=$row2['usermaster_key'];
		}
		
		$pw=MD5(9900);
		$sql3="UPDATE user_master SET password ='$pw' WHERE usermaster_key='$ukeyo'";
