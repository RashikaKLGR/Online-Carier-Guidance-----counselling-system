...
<?php
	$sql1="SELECT * FROM coursetype_master WHERE coursetype_mas_key='$_GET[ct]' AND finact=0";
	$result1 = mysqli_query($link,$sql1);
    while($row1=mysqli_fetch_array($result1)){
		$coursetype_nme=$row1['coursetype_nme'];
		
	}

	if(isset($_POST['btn_delete'])){
		$sql2="UPDATE coursetype_master SET finact=1 WHERE coursetype_mas_key='$_GET[ct]' AND finact=0";
		if(mysqli_query($link,$sql2)){
			echo "<script>
				alert('Sucessfully Update Course Type.');
            ...
            <div class="col-lg-6">
				<section class="panel panel-primary panel-transparent">
					<div class="panel-body">
						<h1 align="center" style="font-size:22px;font-weight:bold"><?php echo $coursetype_nme; ?></h1>
						<br>
						<br>
