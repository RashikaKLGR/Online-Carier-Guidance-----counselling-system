 ...
 * http://www.barcoderesource.com
 return function eke data,checkDigit,yes,in,0 passe width and height
 */

		function DrawCode39Barcode(data,
						   checkDigit)
		{
			//return DrawHTMLBarcode_Code39(data,checkDigit,"yes","in", 0,1,0.6,3,"bottom","center", "","black","white"); 
			return DrawHTMLBarcode_Code39(data,checkDigit,"yes","in", 0,500,0.5,50,"top","center", "font-size:10px;","black","white");
		}
						    ...
						    mode)
		{
			  ...
			  if (mode=="html")
			  {
				  ...
				  {
					if (textStyle=='')
						humanSpan='<br style="display: block;margin: -2px 0;"><span style="font-family : arial; font-size:13pt; padding:0;">'+humanReadableText+'</span>';
					else
