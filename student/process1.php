...
if(isset($_POST['btn_examadd'])){
	...
	/*$sql7="SELECT * FROM  student_exam_details WHERE student_key='$ses_ukey' AND exam_key='$nm1'  AND finact=0";
	...
	/*$sql1="SELECT * FROM  student_exam_details WHERE student_key='$ses_ukey' AND exam_key='$nm1' AND sitting_year='$nm2' AND finact=0";
							...
							<form name="f2" method="post">
										...
										<table width="100%" class="table table-striped table-bordered display" border="1">
											...
											while($row7=mysqli_fetch_array($result7)){
												$txt_subjectkey="txt_subjectkey".$row7['examsubjectmas_key']; //txt_subjectkey4
												$sele_credit="sele_credit".$row7['examsubjectmas_key']; //sele_credit4
				...
				<section class="panel panel-primary panel-transparent">
					<div class="panel-body">
						<div class="row">
						  ...
						  <div class="col-lg-3">
							<a href="update_info1.php"><button type="button" class="btn btn-lg btn-success btn-block">Next</button></a>
						  </div>
					</div>
				</section>
			</div>
